              ...
              cartProducts.map((product:any, index:any) => (
                ...
                <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                  <a href="#" className="w-20 shrink-0 md:order-1">
                    <Image alt={product.name} height={80} width={80} className="h-20 w-20 dark:hidden" src={product.image} />
                    <Image alt={product.name} height={80} width={80} className="hidden h-20 w-20 dark:block" src={product.image}  />
                  </a>
