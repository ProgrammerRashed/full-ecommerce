export default function getJsonData() {
  const data = [
    ...
    },
    {
      ...
      image: "https://i.ibb.co/VqxsRsm/HK9-Ultra-AMOLED-Smartwatch-Chat-GPT-Smartwatch-Gray-Color.jpg",
      brand: "",
    ...
    },
    {
      ...
      description:
        "Experience the future of wearable technology with the HK9 Ultra AMOLED Smartwatch. Stylish, functional, and packed with features.",
      image:
        "https://i.ibb.co/bXDK57p/HK-9-ultra-Chatgpt-Black.jpg",
      brand: "",
      category: "Smartwatches",
      price: "3400",
    ...
    },
    {
      ...
      image:
        "https://i.ibb.co/C8SLRVZ/TABWD-4-G-Router-MF920.jpg",
      brand: "",
      category: "Router",
      price: "1220",
      tags: ["bestselling", "dealoftheday"]
    ...
    },
    {
      ...
      image:
        "https://i.ibb.co/HPb9z0X/Jmary-KP-2205-Tripod-in-BD.png",
      brand: "",
      category: "Tripod",
      price: "1120",
      tags: ["bestselling", "dealoftheday"]
